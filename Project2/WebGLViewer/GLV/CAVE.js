...
var CAVE = { 
    ...
    drawStereo: function(surface){ 
        ...
        viewL = surface.viewingMatrix(this.eyes[this.EYEL].pos); 
        projL = surface.projectionMatrix(this.eyes[this.EYEL].pos, this.near, this.far); 
        GLV.scene.draw(viewL, projL); 
         
        // Right 
        gl.colorMask(false, false, true, false); 
        viewR = surface.viewingMatrix(this.eyes[this.EYER].pos); 
        projR = surface.projectionMatrix(this.eyes[this.EYER].pos, this.near, this.far); 
